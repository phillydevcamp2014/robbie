...
module.exports = (robot) ->
  ...
  robot.respond /buddha start|dice start|bdstart/i, (msg) ->
    buddha.startGame msg, msg.message.user

  robot.respond /buddha stats|dice stats/i, (msg) ->
    msg.reply buddha.playerstats(msg.message.user)

  robot.respond /buddha stats all|dice stats all|bdstat/i, (msg) ->
    buddha.stats msg

  robot.respond /buddha reset|dice reset/i, (msg) ->
    buddha.reset msg, msg.message.user

  robot.respond /(buddha take|dice take|bdt) ([\w .-]+)/i, (msg) ->
